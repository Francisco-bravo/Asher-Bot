...
export function defineGuildSession({ createAudioPlayer, AudioPlayerStatus, getDefaultMusicVolume, onSoundIdle }) {
  return class GuildSession {
    constructor(guildId = null) {
      ...
      this.soundActive = 0
      this.emptySince = 0             // ms desde que el canal quedó sin personas (0 = hay gente / desconectado)
      this.activeProcs = []
      ...
      this.djPlayedIds = new Set()    // ids de canciones ya elegidas por el DJ automático en esta sesión
      this.djLastPlaylistId = null    // playlist de la última canción sonada (para que el DJ la continúe)
